...
## Algorithm
1. Step 1: Sample dataset
2. Step 2: Split into features and target
3. Step 3: Create and train SGDClassifier for Logistic Regression
4. Step 4: Predict placement for a new student
